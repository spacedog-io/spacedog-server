...
public class ESSearchSourceBuilder { // extends ToXContentToBytes {
	 ...
	 *
	 * @see io.spacedog.client.elastic.ESQueryBuilders
	 */
	...
	// this.timeoutInMillis = TimeValue.parseTimeValue(timeout, null,
	 ...
	 */
	// public SearchSourceBuilder aggregation(AbstractAggregationBuilder
	// aggregation) {
	 ...
	 *            the returned _source
	 */
	// public SearchSourceBuilder fetchSource(@Nullable String include,
	// @Nullable String exclude) {
	// return fetchSource(include == null ? Strings.EMPTY_ARRAY : new String[] {
	// include },
	 ...
	 *            filter the returned _source
	 */
	// public SearchSourceBuilder fetchSource(@Nullable String[] includes,
	 ...
	 */
	// public SearchSourceBuilder fetchSource(@Nullable FetchSourceContext
	// fetchSourceContext) {
	...
	public void innerToXContent(ESJsonContentBuilder builder) throws IOException {
		...
		if (postQueryBuilder != null) {
			...
			postQueryBuilder.toJsonContent(builder);
		}
		...
		// if (rescoreBuilder.windowSize() == null && defaultRescoreWindowSize
		// != null) {
		// builder.field("window_size", defaultRescoreWindowSize);
		// }
		// builder.endObject();
