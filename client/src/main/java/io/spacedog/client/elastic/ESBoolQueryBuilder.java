...
public class ESBoolQueryBuilder extends ESQueryBuilder implements ESBoostableQueryBuilder<ESBoolQueryBuilder> {
	...
	/**
	 * Adds a query that <i>should</i> appear in the matching documents. For a
	 * boolean query with no <tt>MUST</tt> clauses one or more
	 * <code>SHOULD</code> clauses must match a document for the BooleanQuery to
	 * match.
	 *
	...
	/**
	 * Specifies a minimum number of the optional (should) boolean clauses which
	 * must be satisfied.
	 * <p/>
	 * <p>
	...
	/**
	 * Returns <code>true</code> iff this query builder has at least one should,
	 * must, must not or filter clause. Otherwise <code>false</code>.
	 */
