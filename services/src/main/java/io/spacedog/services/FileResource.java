...
public class FileResource extends AbstractS3Resource {
	...
	@Delete("/:a")
	@Delete("/:a/")
	public Payload delete(String a) throws JsonParseException, JsonMappingException, IOException {
	...
	@Delete("/:a/:b")
	@Delete("/:a/:b/")
	public Payload delete(String a, String b) throws JsonParseException, JsonMappingException, IOException {
	...
	@Delete("/:a/:b/:c")
	@Delete("/:a/:b/:c/")
	public Payload delete(String a, String b, String c) throws JsonParseException, JsonMappingException, IOException {
	...
	private Payload doDelete(Optional<String> path) throws JsonParseException, JsonMappingException, IOException {
